# Kaggriculture V6: Reactive Same-Turn Sale Race & Wheat Round Trip with Survival Guard.
# Fusion: V45 First-Turn Wheat Round Trip + V44 Same-Turn Race Escalator + _r60 Survival Guard.
# Upstream attribution: aurax7, Ahmed Berat Ozer, Rayk Kretzschmar, yhay81, thomastschinkel, tetsutani, destbreso.
# All Apache-2.0 notices retained below.
#                                  Apache License
