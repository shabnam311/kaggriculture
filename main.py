...
def _kaggle_submission_entrypoint(obs, configuration=None, *args, **kwargs):
    return agent(obs, configuration, *args, **kwargs)

def kaggriculture_e283_agent(obs, configuration=None, *args, **kwargs):
    return agent(obs, configuration, *args, **kwargs)
